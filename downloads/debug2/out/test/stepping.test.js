...
suite('Stepping', () => {
    ...
    suite('basic', () => {
        ...
        test('returns the same frameIDs between steps', () => __awaiter(void 0, void 0, void 0, function* () {
            let firstFrameIDs;
            yield start();
    ...
    suite('skipFiles', () => {
        test('steps through un-sourcemapped file', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        test('steps through sourcemapped file', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        test('still stops at breakpoint in skipped file', () => __awaiter(void 0, void 0, void 0, function* () {
            const program = path.join(DATA_ROOT, 'calls-between-sourcemapped-files/out/sourceA.js');
        ...
        test('can toggle skipping on and off', () => __awaiter(void 0, void 0, void 0, function* () {
            const program = path.join(DATA_ROOT, 'calls-between-sourcemapped-files/out/sourceA.js');
            const programASource = path.join(DATA_ROOT, 'calls-between-sourcemapped-files/src/sourceA.ts');
            const programBSource = path.join(DATA_ROOT, 'calls-between-sourcemapped-files/src/sourceB.ts');
            const bpLineA = 8;
        ...
        test('when generated script is skipped via regex, the source can be un-skipped', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        test('when a non-sourcemapped script is skipped via regex, it can be unskipped', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        test.skip('can toggle skipping a non-sourcemapped file', () => __awaiter(void 0, void 0, void 0, function* () {
            // Using this program, but run with sourcemaps disabled
            const program = path.join(DATA_ROOT, 'calls-between-sourcemapped-files/out/sourceA.js');
            const sourceB = path.join(DATA_ROOT, 'calls-between-sourcemapped-files/out/sourceB.js');
            // Skip the full B generated script via launch config
        ...
        test('when multiple generated scripts are skipped via one regex, one source can be un-skipped and re-skipped', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        test('can skip node internal files using <node_internals>', () => __awaiter(void 0, void 0, void 0, function* () {
            const program = path.join(DATA_ROOT, 'calls-between-sourcemapped-files/out/sourceA.js');
            const programSource = path.join(DATA_ROOT, 'calls-between-sourcemapped-files/src/sourceA.ts');
            ...
            yield dc.nextTo('step', { path: programSource, line: 9 });
