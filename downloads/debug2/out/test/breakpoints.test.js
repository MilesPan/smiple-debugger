...
suite('Breakpoints', () => {
    ...
    suite('setBreakpoints in TypeScript', () => {
        ...
        test('can set a breakpoint in inlined sources', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        test('still resolves sourcemap paths when they are absolute local paths', () => __awaiter(void 0, void 0, void 0, function* () {
            const TEST_ROOT = path.join(DATA_ROOT, 'sourcemaps-local-paths');
            yield execP('npm install', { cwd: TEST_ROOT });
            yield execP('npm run postinstall', { cwd: TEST_ROOT }); // This doesn't run automatically on Linux for some reason.
    ...
    suite('setExceptionBreakpoints', () => {
        ...
        test('should not stop on exception in <node_internals> when skipFiles is used', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        test('should still stop on exception in user code when skipFiles is used with <node_internals>', () => __awaiter(void 0, void 0, void 0, function* () {
            const program = path.join(DATA_ROOT, 'programWithException.js');
            return Promise.all([
                dc.waitForEvent('initialized').then(event => {
                    return dc.setExceptionBreakpointsRequest({
    ...
    suite('exception scope', () => {
        ...
        test('should only show exception scope in the first frame', () => {
            ...
            return Promise.all([
                ...
                dc.launch({ program: PROGRAM }),
                dc.assertStoppedLocation('exception', { path: PROGRAM, line: EXCEPTION_LINE }).then((response) => __awaiter(void 0, void 0, void 0, function* () {
                    const frame0Id = response.body.stackFrames[0].id;
                    const frame0Scopes = yield dc.scopesRequest({ frameId: frame0Id });
                    ...
                    const frame1Scopes = yield dc.scopesRequest({ frameId: frame1Id });
